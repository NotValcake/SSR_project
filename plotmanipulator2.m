...
% - Rispetto alla funzione plotmanipulator, questa funzione plotta il
%   manipolatore ruotato adeguatamente, per allinearsi al s.d.r. utilizzato
%   nella relzione, se si intende utilizzare plotmanipulator insieme a plot
%   ellipsoid, utilizzare plotmanipulator
%
...
% manipulator
plot3([z1i z2i z3i z3 z4 z5],[y1i y2i y3i y3 y4 y5], [x1i x2i x3i x3 x4 x5], 'LineWidth',2,'color',colore);
plot3([z0 z1ii z3i], [y0 y1ii y3i],[x0 x1ii x3i], 'LineWidth', 2,'color', colore);
% base
plot3([z0 z1i],[y0 y1i],[x0 x1i],'-','color','k', 'LineWidth', 2, 'MarkerSize',5);
% joints
plot3([z0 z1i z1ii z2i z3 z4 z5],[y0 y1i y1ii y2i y3 y4 y5],[x0 x1i x1ii x2i x3 x4 x5], 'o','color', colore, 'MarkerSize', 5, 'MarkerFaceColor',colore);
% end effector
