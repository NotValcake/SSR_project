...
% manipulator
plot([y1i y2i y3i y3 y4 y5], [x1i x2i x3i x3 x4 x5],'LineWidth', 2,'color',colore);
plot([y0 y1ii y3i], [x0 x1ii x3i],'LineWidth', 2,'color', colore);
% base
plot([y0 y1i], [x0 x1i], '*-','color','k', 'LineWidth', 2, 'MarkerSize', 5);
% joints
plot([y0 y1i y1ii y2i y3 y4 y5], [x0 x1i x1ii x2i x3 x4 x5], 'o','color', colore, 'MarkerSize', 5, 'MarkerFaceColor', colore);
% end effector
plot(y5, x5, 'diamond','color', colore, 'MarkerSize', 10, 'MarkerFaceColor', colore);
% axis equal
xlabel x
ylabel y
axis equal
